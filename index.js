...
// Setup saveColorArr by loading from the local storage
let saveColorArr = []
if (localStorage.getItem('saveColorArr')){
    saveColorArr = JSON.parse(localStorage.getItem('saveColorArr'))
}

// Taking Control of Elements
// From Menu Container
const colorForm = document.getElementById('color-form')
const statusMsg = document.getElementById('status-msg')
const switchGrid = document.getElementById('switch-grid') //Toggle for Dark Mode switches
const inputColor = document.querySelector("input[type='color']") //Color Picker
...
// From Generated Color Palette Display
...
// Initial Code to run upon loading the page

// An empty array for storing fetched / generated color palette
let colorValArr = []
...
// When enter is pressed in the text input area
// This generates color palette from the base color of the 
// current text area --> Which update the text value of other format
// as well as the color picker
...
// For giving hints when mouse hovers over the get / save color btn
// that the color palette will be generated by referring to the color picker
// which may not align with the text input
...
// Listening for when the 'get color' button is clicked
// which always refer to the color picker to generate color palette
...
// Perform 2 tasks (both are triggered by single click)
// 1. Listen to click on color areas for copy the text into clipboard
// 2. Listen to when the 'render saved color' button is clicked
...
// Perform 2 tasks (both are triggerd by double click)
// 1. Copy the text input for the HEX, RGB and HSL
// 2. Delete saved color 
